...
while True:
    ...
    p = pg.locateCenterOnScreen(r'images/Pekka.png', confidence=0.8,region=(1315,833,1745,995))
    mk = pg.locateCenterOnScreen(r'images/MegaKnight.png',confidence=0.8,region=(1315,833,1745,995))
    hr = pg.locateCenterOnScreen(r'images/HogRider.png',confidence=0.8,region=(1315,833,1745,995))
    gg = pg.locateCenterOnScreen(r'images/GoblinGiant.png',confidence=0.8,region=(1315,833,1745,995))
    mw = pg.locateCenterOnScreen(r'images/MotherWitch.png',confidence=0.8,region=(1315,833,1745,995))
    mh = pg.locateCenterOnScreen(r'images/MinionHorde.png',confidence=0.8,region=(1315,833,1745,995))
    rg = pg.locateCenterOnScreen(r'images/RoyalGiant.png',confidence=0.8,region=(1315,833,1745,995))
    eg = pg.locateCenterOnScreen(r'images/ElectroGiant.png',confidence=0.8,region=(1315,833,1745,995))
    if a != None: 
        print("NOT IN BATTLE!!")
